...
const sections = [
  { title: 'Information We Collect', content: `When you register on HostelMS, we collect personal information such as your full name, email address, phone number, roll number, course, and branch. We also collect usage data such as login times, actions performed within the platform, and device information to improve system performance and security.` },
  ...
  { title: 'Cookies', content: `HostelMS uses session tokens stored in your browser's local storage to keep you signed in. We do not use third-party tracking cookies or advertising cookies. You can clear your browser storage at any time to log out of all sessions.` },
  { title: 'Third-Party Services', content: `HostelMS integrates with Razorpay for payment processing. When you make a payment, your transaction data is handled by Razorpay in accordance with their privacy policy. We only store the payment status and receipt reference; we do not store card or bank details on our servers.` },
  ...
  { title: 'Changes to This Policy', content: `We may update this Privacy Policy from time to time. Any changes will be reflected on this page with an updated effective date. Continued use of HostelMS after changes are posted constitutes your acceptance of the revised policy.` },
];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        <div className="mb-10">
          ...
          <p className="mt-4 text-slate-600 leading-relaxed">At HostelMS, we are committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal information when you use our platform.</p>
        </div>
